...
const ContactLoginPage = () => {
  return (
    <div>
      ...
      <div className="main-content pt-20"> {/* Add top padding here */}
        <div className="relative flex flex-col md:flex-row justify-between gap-12 p-8 h-screen bg-gray-100">
          ...
          <section className="w-full md:w-1/2 bg-white shadow-md rounded-lg p-6">
            ...
            <form className="flex flex-col gap-4">
              <input className="p-3 border rounded" type="text" placeholder="Your Name" />
              <input className="p-3 border rounded" type="email" placeholder="Your Email" />
              <textarea className="p-3 border rounded" placeholder="Your Message" rows="4"></textarea>
          ...
          <section className="w-full md:w-1/2 bg-white shadow-md rounded-lg p-6">
            ...
            <form className="flex flex-col gap-4">
              <input className="p-3 border rounded" type="email" placeholder="Email Address" />
              <input className="p-3 border rounded" type="password" placeholder="Password" />
