    ...
    <div className="main-content pt-24">
      ...
      <div className="relative h-full w-full bg-slate-950">
        ...
        <div
          ...
          style={{ backgroundImage: `url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQklVwKcPGkcAL7oTZB8Y9Aje2-7macJG0qCg&s')` }}
        >
         <div className="absolute inset-0 bg-black bg-opacity-70 flex flex-col justify-center items-center p-6 md:p-8 lg:p-10">
  <h1 className="text-white text-4xl md:text-5xl lg:text-6xl font-extrabold text-center">
    Unlock the Enchantment of Netflix Animation
  </h1>
  <p className="text-white text-lg md:text-xl lg:text-2xl text-center mt-3 md:mt-5">
    Journey through a spellbinding collection of animated wonders <br /> that blend heart, humor, and unforgettable stories—only on Netflix.
  </p>
</div>
