...
// import { MusicProvider, MusicContext } from "../MusicContext";
...
//                   >
//                     {isMusicPlaying ? <MdPause size={24} /> : <MdPlayArrow size={24} />}
//                   </button>
//                   <button
//                     onClick={() => setCurrentTrackIndex((currentTrackIndex + 1) % tracks.length)}
...
//                     className={`bg-${isFavorite ? 'red' : 'gray'}-500 text-white px-4 py-2 rounded hover:bg-${isFavorite ? 'red' : 'gray'}-700 transition-colors duration-300`}
//                   >
