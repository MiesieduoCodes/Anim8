...
const Sword = () => {
  ...
  const story = "Sword Art Online follows players trapped in a virtual reality MMORPG where dying in the game means dying in real life. Kirito, the protagonist, must navigate this dangerous world to find a way to escape and save his friends.";
  ...
  return (
    <div className="main-content pt-24">
      ...
      <div className="max-w-6xl mx-auto p-4">
        <h1 className="text-2xl md:text-3xl font-bold text-center mt-4">Sword Art Online Movies</h1>
